...
const AddItem = () => {
    ...
    const [userType, setUserType] = useState("AucMan");
            ...
            <form className="flex flex-col items-center justify-center gap-5 px-4 form-style">
                ...
                <div className="max-w-4xl w-full bg-white border border-gray-300 shadow-sm rounded p-6">
                    ...
                    <div className="flex mt-4 gap-4 flex-wrap justify-around">
                        <button className={`border border-gray-300 rounded p-6 hover:shadow-sm transition-colors duration-300 ${userType === 'AucMan' ? "bg-[#1e3a5f] text-white" : "hover:bg-gray-200"}`} onClick={() => setUserType('AucMan')} type="button">
                            <FontAwesomeIcon icon={faGavel} size="2xl" />
                            <p className="mt-2 text-center">Auction Manager</p>
                        </button>
                        <button className={`border border-gray-300 rounded p-6 hover:shadow-sm transition-colors duration-300 ${userType === 'InvMan' ? "bg-[#1e3a5f] text-white" : "hover:bg-gray-200"}`} onClick={() => setUserType('InvMan')} type="button">
