...
import { faHeart as faHeartSolid, faLocationDot, faClock, faUsers, faEye } from "@fortawesome/free-solid-svg-icons";
    ...
    return(
      ...
      >
        <div className="relative">
          ...
          {isFavorite ? (
              <FontAwesomeIcon icon={faHeartSolid} className="text-red-500" onClick={(e) => handleFavoriteClick(e, false)} />
            ) : (
              <FontAwesomeIcon icon={faHeartRegular} className="text-gray-500" onClick={(e) => handleFavoriteClick(e, true)} />
            )
          }
          </div>
        </div>
